            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="card shadow-lg p-3 mb-5 bg-white ">
                        <div class="card-header bg-dark text-white font">Formulario de <?php echo $nombrePagina; ?></div>
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                           <button type='submit' class='btn btn-estilo btn-primary btn-sm d50000 red accent-4'
                                                   title='Eliminar pais'  name='eliminarPais'  value='{$pais['country_id']}'>
                                                   <i class='fas fa-trash i-acciones'></i>
                                           </button>
                                           <button type='submit' class='btn btn-estilo btn-sm btn-danger ' title='Editar pais' 
                                                   name='editarPais' value='{$pais['country_id']}'>
