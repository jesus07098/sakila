...
function obtenerInfoTiendas($conexion)
{
    $sql = "select sto.store_id, sto.manager_staff_id,sto.address_id, sta.first_name, a.address  from store as sto left join staff as sta on sto.manager_staff_id = sta.staff_id
